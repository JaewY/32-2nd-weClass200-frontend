        ...
        <SectionWrap>
          ...
          <Section height="136px">
            ...
            <Div>
              ...
              <Button width="80px" color="white" bgColor="black">
                쿠폰 변경
              </Button>
            </Div>
          ...
          <Section>
            ...
            <Div marginTop>
              <Div>
                <Button border bgColor="white" margin width="288px">
                  weBank
                </Button>
                <Button border bgColor="white" margin width="288px">
                  달란트
...
const Button = styled.button`
  ...
  align-items: center;
  outline: black;
  border: ${props => (props.border ? "1px solid lightgray" : "none")};
